...
export async function levelBox(token, query) {
  ...
  <div>level</div>
   <svg class="level-circle" viewBox="0 0 100 100" width="5em" height="5em" preserveAspectRatio="xMidYMid meet">
    ...
    <div class="box">
      ...
      <div class="line-wrap">
        <svg height="50" width="294">
          <line x1="5" y1="10" x2="${doneWidth - 10}" y2="10" style="stroke:red;stroke-width:12" />
        </svg>
      ...
      <div class="line-wrap">
        <svg height="50" width="294">
          <line x1="5" y1="10" x2="${receivedWidth - 10 }" y2="10" style="stroke:red;stroke-width:12" />
        </svg>
